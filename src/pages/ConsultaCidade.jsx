...
export default function CadastroCidades() {
  ...
  async function salvarCidade() {
    ...
    try {
      ...
      if (editandoId) {
        // Lógica PATCH com barra final para evitar erro 405
      ...
      alert("Erro ao salvar cidade. Verifique a conexão.");
    } finally {
      setSalvando(false);
    }
  }
  ...
  async function excluir(id) {
    const ok = window.confirm("Deseja realmente excluir esta cidade?");
    if (!ok) return;
    ...
    >
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        >
          <div
            style={{
              ...
              padding: "8px 14px",
              borderRadius: 999,
              background: editandoId ? "#fff3ea" : "#efeafd",
        ...
        >
          ...
          {loading ? (
            <p style={{ color: "#64748b" }}>Carregando cidades...</p>
          ) : (
            <div style={{ display: "grid", gap: 10 }}>
              {cities.map((item) => (
                ...
                >
                  <span style={{ fontSize: 18, fontWeight: "bold", color: "#403d7c" }}>
                    {item.name}
                  </span>
